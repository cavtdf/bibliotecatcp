...
<div id="content">
    ...
    <!-- Modal de Confirmacion -->
        <div class="modal modal-danger fade" id="confirmar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Confirmar prestamo</h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('solicitado.update','id_confirma')}}" method="post">
                            {{method_field('PUT')}}
                            {{csrf_field()}}
                            <div class="modal-body">
                                <p class="text-center">
                                    Confirma el prestamo del material ?
                                </p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('solicitado.destroy','codigo')}}" method="post">
                            ...
                            <div class="modal-body">
                                <p class="text-center">
                                    Seguro que quiere cancelar el prestamo ?
                                </p>
