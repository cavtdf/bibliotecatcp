            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Recepcion de prestamos</h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('devolucion.update','id_confirma')}}" method="post">
                            {{method_field('PUT')}}
                            {{csrf_field()}}
                            <div class="modal-body">
                                <p class="text-center">
                                    Confirma la recepcion del material ?
                                </p>
