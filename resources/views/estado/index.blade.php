...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm pull-right header-btn hidden-mobile">Nuevo Estado</button>
        ...
        */
        ...
        /* BASIC ;*/
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                 action_url = "{{ route('estado.store') }}";
                }

                if($('#action').val() == 'Edit')
                {
                 action_url = "{{ route('estado.update') }}";
                }
                $.ajax({
                    url: action_url,
                    method:"POST",
