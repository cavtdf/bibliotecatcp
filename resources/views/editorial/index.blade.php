...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm pull-right header-btn hidden-mobile">Nueva Editorial</button>
               ...
               <div class="modal-body">
                ...
                <form method="post" id="sample_form" class="form-horizontal">
                 ...
                 <div class="form-group">
                   <label class="control-label col-md-4" >editorial : </label>
                   <div class="col-md-8">
    ...
    $(document).ready(function() {
        ...
        /* BASIC ;*/
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                 action_url = "{{ route('editorial.store') }}";
                }

                if($('#action').val() == 'Edit')
                {
                 action_url = "{{ route('editorial.update') }}";
                }
                $.ajax({
                    url: action_url,
                    method:"POST",
                ...
                $(document).on('click', '.edit', function(){
                   ...
                   $('#form_result').html('');
                   $.ajax({
                    url :"/editorial/"+id+"/edit",
                    dataType:"json",
                    success:function(data)
                    {
                     $('#editorial').val(data.result.editorial);
                     $('#hidden_id').val(id);
