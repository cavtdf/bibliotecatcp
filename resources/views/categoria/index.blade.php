...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm pull-right header-btn hidden-mobile">Nueva Categoria</button>
        ...
        */
        ...
        /* BASIC ;*/
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                 action_url = "{{ route('categoria.store') }}";
                }

                if($('#action').val() == 'Edit')
                {
                 action_url = "{{ route('categoria.update') }}";
                }
                $.ajax({
                    url: action_url,
                    method:"POST",
                ...
                $(document).on('click', '.edit', function(){
                   ...
                   $.ajax({
                    ...
                    success:function(data)
                    {
                     $('#categoria').val(data.result.categoria);
                     $('#hidden_id').val(id);
